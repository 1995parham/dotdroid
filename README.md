...
| :---------------------------------------: | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------ |
|          Android Password Store           | An open-source password manager that securely stores and manages passwords using GPG encryption. (based on [`gopass`](https://github.com/gopasspw/))                                                                                                      | [GitHub](https://github.com/agrahn/Android-Password-Store)                                                                                              |
...
|                Termux-API                 | Access Android functions from Termux                                                                                                                                                                                                                      | [F-Droid](https://f-droid.org/en/packages/com.termux.widget/)                                                                                           |
|                  GitSync                  | Android git client for syncing a repository between remote and a local directory                                                                                                                                                                          | [GitHub](https://github.com/ViscousPot/GitSync)                                                                                                         |
